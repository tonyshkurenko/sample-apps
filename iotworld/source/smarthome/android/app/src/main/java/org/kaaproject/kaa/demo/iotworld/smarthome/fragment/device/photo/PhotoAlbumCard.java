...
public class PhotoAlbumCard extends RelativeLayout {
    ...
    public void bind(PhotoAlbumInfo album, PhotoFrameStatusUpdate status) {
        ...
        if (status != null && 
            ...
            mPhotoNumberView.setText(getResources().getString(R.string.photo_number_text, String.valueOf(status.getPhotoNumber()), String.valueOf(album.getSize())));
            ...
            mPhotoCountView.setText(getResources().getString(R.string.photos_count_text, String.valueOf(album.getSize())));
